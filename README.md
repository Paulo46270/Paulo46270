...
local Window = OrionLib:MakeWindow({Name = "atisu hub by paulo ", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "atisu hub by paulo "})

OrionLib:MakeNotification({
	Name = "atisu hub by paulo ",
	Content = "Choose Teams Bro?",
	Image = "rbxassetid://81367664460137",
	Time = 7
})

OrionLib:MakeNotification({
	Name = "atisu hub by paulo ",
	Content = "atisu hub by paulo ",
	Image = "rbxassetid://81367664460137",
	Time = 25
})
...
local W = Window:MakeTab({
    Name = "Welcome",
    Icon = "rbxassetid://81367664460137",
    PremiumOnly = false
})
...
W:AddLabel("[+] atisu hub by paulo  is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "atisu hub by paulo (Noitification)",
